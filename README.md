...
global:
  ...
  ingress:
    enabled: true
    className: ""
    host: "camunda.apps.your-cluster.example.com"
    tls:
      enabled: true
      secretName: camunda-platform-tls

  # EKSTERNI ELASTICSEARCH
  elasticsearch:
    enabled: true
    external: true
    auth:
  ...
  identity:
    auth:
      enabled: true
      publicIssuerUrl: "https://camunda.apps.your-cluster.example.com/auth/realms/camunda-platform"
      issuerBackendUrl: "http://camunda-platform-keycloak:8080/auth/realms/camunda-platform"
      tokenUrl: "https://camunda.apps.your-cluster.example.com/auth/realms/camunda-platform/protocol/openid-connect/token"
      jwksUrl: "https://camunda.apps.your-cluster.example.com/auth/realms/camunda-platform/protocol/openid-connect/certs"
      type: KEYCLOAK
...
orchestration:
  ...
  ingress:
    grpc:
      enabled: true
      host: "zeebe-grpc.apps.your-cluster.example.com"
      tls:
        enabled: true
        secretName: camunda-platform-zeebe-grpc-tls
  
  # Service certificate auto-generation
  service:
    annotations:
